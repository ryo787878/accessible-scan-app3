...
export const env = {
  ...
  scanJobConcurrency: toPositiveInt(process.env.SCAN_JOB_CONCURRENCY, 1),
  scanQueueMax: toPositiveInt(process.env.SCAN_QUEUE_MAX, 20),
  scanMaxViolationsPerPage: toPositiveInt(process.env.SCAN_MAX_VIOLATIONS_PER_PAGE, 200),
  scanMaxNodesPerViolation: toPositiveInt(process.env.SCAN_MAX_NODES_PER_VIOLATION, 50),
