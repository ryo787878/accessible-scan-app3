...
import { jaGlossaryLinks } from "@/lib/content/ja-guides";
import { createBreadcrumbData } from "@/lib/seo/breadcrumbs";
import { buildPageMetadata } from "@/lib/seo/metadata";

const title = "アクセシビリティ用語集";
const description = "アクセシビリティ診断で頻出する用語の一覧ページです。";
const canonicalPath = "/ja/glossary";
const breadcrumb = createBreadcrumbData([
  { label: "ホーム", path: "/" },
  { label: "日本語ガイド", path: "/ja" },
  { label: "用語集", path: canonicalPath },
]);

export const metadata: Metadata = buildPageMetadata({ title, path: canonicalPath, description, ogType: "blog" });

export default function JaGlossaryIndexPage() {
  return (
