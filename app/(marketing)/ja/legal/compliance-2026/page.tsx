...
const title = "Webアクセシビリティ法令対応ハブ（2026）";
const description = "法令対応を進めるための確認項目と、実務で見落としやすい論点を整理したページです。";
const canonicalPath = "/ja/legal/compliance-2026";
...
export default function ComplianceHub2026Page() {
  return (
    <PageShell maxWidth="4xl">
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "法令対応", item: canonicalUrl(canonicalPath) },
        ]}
      />
